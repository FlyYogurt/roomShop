<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<%@ page import="com.xin.model.User" %>
                            ...
                            <form action="${ pageContext.request.contextPath }/cartController/addCart.action" method="post" id="cartForm">
                                ...
                                <div class="product-shop col-lg-7 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-option">
                                        <p class="form-option-title">选择属性:</p>
                                        <div class="add-to-box">
                                            <div class="add-to-cart">
                                                ...
                                                <button onClick="saveCart()" class="button btn-cart" title="Add to Cart" type="button">添加到购物车</button>
                                            </div>
                ...
                <div class="product-collateral col-lg-12 col-sm-12 col-xs-12">
                    <div class="add_info">
                        <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                            ...
                            <li> <a href="#product_tabs_custom" data-toggle="tab">选房送花</a> </li>
                            <li> <a href="#product_tabs_custom1" data-toggle="tab">送花攻略</a> </li>
                        </ul>
                        <div id="productTabContent" class="tab-content">
                            <div class="tab-pane fade in active" id="product_tabs_description">
                                <div class="std">
                                    <p>地理位置优越, 采光性好 房子周围有 碧绿的小树 芬香的小花
                                        时不时的还有小鸟喳喳地叫着.环境优美,交通便利!</p>
                                    <p> 严格按照标准建造 房内无异味. 周围空气清新,
                                        多种风格,极具特色!.</p>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="product_tabs_custom">
                                <div class="product-tabs-content-inner clearfix">
                                    <p><strong>送什么花呢</strong><span>&nbsp;
                                    <p>我们这里有:红玫瑰 粉玫瑰 白玫瑰 黄玫瑰 紫玫瑰 香槟玫瑰</p>
                                    <p>百合 康乃馨 蓝色妖姬郁金香 马蹄莲 扶郎花.</p></span></p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="product_tabs_custom1">
                                <div class="product-tabs-content-inner clearfix">
                                    <p> <strong> 不同的花送给不同的人 </strong><span>&nbsp;
                                        <p>我们会根据您的要求,根据您要送的人</p>
                                        为您推荐不同的花的种类,花的搭配,送恋人,送朋友,
                                        送父母,送长辈.我们将竭诚为您服务.</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
