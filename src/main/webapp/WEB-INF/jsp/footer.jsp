...
<footer>
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12 col-md-3">
					<div class="footer-links">
						<h4>服务</h4>
						<ul class="links">
							<li><a href="#" title="Product Recall">产品召回</a></li>
							<li><a href="#" title="Gift Vouchers">礼品券</a></li>
							<li><a href="#" title="Returns &amp; Exchange">退换</a></li>
							<li><a href="#" title="Shipping Options">送货选项</a></li>
							<li><a href="#" title="Help &amp; FAQs">
								帮助</a></li>
							<li><a href="#" title="Order history">
								常见问题</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-sm-4 col-xs-12 col-md-2">
					<div class="footer-links">
						...
						<ul class="links">
							...
							<li><a href="#">
								发展趋势</a></li>
							<li><a href="${pageContext.request.contextPath}/html/about.jsp">关于我们</a></li>
							<li><a href="${pageContext.request.contextPath}/html/about.jsp">联系我们</a></li>
							<li><a href="${pageContext.request.contextPath}/html/about.jsp">我的信息</a></li>
						</ul>
					</div>
				</div>
	...
	<div class="footer-top">
		<div class="container">
			<div class="row">
				...
				<address>
					<p> <i class="fa fa-map-marker"></i>公司, 12/34 - 西街道, China, 北京 </p>
	...
	<div class="footer-bottom">
		<div class="container">
			<div class="row">
				<div class="col-sm-5 col-xs-12 coppyright">Copyright &copy; 2020.
					公司名称版权所有.</div>
